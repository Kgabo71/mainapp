                            ...
                            <form class="" action="<?php echo site_url('home/update_profile/update_basics'); ?>" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-3">
                                        ...
                                        <label class="text-dark fw-600"><?php echo site_phrase('add_your_instagram_link'); ?></label>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text"><i class="fab fa-instagram"></i></span>
                                            <input type="text" class="form-control bg-white-2 text-14px" maxlength="60" name="instagram_link" placeholder="<?php echo site_phrase('instagram_link'); ?>" value="<?php echo $social_links['instagram']; ?>">
                                        </div>
                                    </div>
