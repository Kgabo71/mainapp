    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="right-menubar ms-auto">
        ...
        <?php if($user_login): ?>
          ...
          <!--<li><a class="dropdown-item" href="<?php echo site_url('home/my_courses') ?>"><?php echo site_phrase('Community') ?></a></li>-->
          ...
          <div class="wisth_tgl_2div">
            ...
            <div class="menu_pro_wish">
              ...
              <div class="menu_pro_btn">
                <a href="#" onclick="actionTo('<?php echo site_url('home/handle_buy_now/' . $course_details['id']); ?>')" class="btn btn-primary text-white"> <?php echo get_phrase('Checkout'); ?></a>             </div>
            </div>
          </div>
        </div>
