            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
            	<?php if(isset($course_1_details['title'])): ?>
	                <div class="card">
	                    ...
	                    <img src="<?php echo $this->crud_model->get_course_thumbnail_url($course_1_details['id']); ?>" alt="<?php echo $course_1_details['title']; ?>">
	                    <div class="d-flex">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <?php if(isset($course_2_details['title'])): ?>
	                <div class="card">
	                    ...
	                    <img src="<?php echo $this->crud_model->get_course_thumbnail_url($course_2_details['id']); ?>" alt="<?php echo $course_2_details['title']; ?>">
	                    <div class="d-flex">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <?php if(isset($course_3_details['title'])): ?>
	                <div class="card">
	                    ...
	                    <img src="<?php echo $this->crud_model->get_course_thumbnail_url($course_3_details['id']); ?>" alt="<?php echo $course_3_details['title']; ?>">
	                    <div class="d-flex">
                      ...
                      <td class="border-0" scope="col">
                      	<?php if(isset($course_1_details['title'])): ?>
                      		<?php if($course_1_details['discount_flag']): ?>
                      			<center><img src="<?php echo site_url('assets/frontend/default-new/image/compare-r.png') ?>" alt=""></center>
                      		<?php else: ?>
                      			<center><img src="<?php echo site_url('assets/frontend/default-new/image/compare-x.png') ?>" alt=""></center>
                      		<?php endif; ?>
                      	<?php endif; ?>
                      </td>
                      <td class="border-0" scope="col">
                  ...
                  <tbody>
                      ...
                      <td>
                      	<?php if(isset($course_1_details['title'])): ?>
                      		...
                      		<?php else: ?>
                      			<i class="far fa-flag"></i>  <?php echo $course_1_details['expiry_period'].' '.get_phrase('Days'); ?>
                      		<?php endif; ?>
                      	<?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_2_details['title'])): ?>
                      		<?php if($course_2_details['expiry_period'] <= 0): ?>
                      			<i class="far fa-flag"></i> <?php echo get_phrase('Lifetime'); ?>
	                      	<?php else: ?>
	                      		<i class="far fa-flag"></i>  <?php echo $course_2_details['expiry_period'].' '.get_phrase('Days'); ?>
	                      	<?php endif; ?>
	                    <?php endif; ?>
                      </td>
                      <td>
                      	<?php if(isset($course_3_details['title'])): ?>
                      		<?php if($course_3_details['expiry_period'] <= 0): ?>
	                      		<i class="far fa-flag"></i> <?php echo get_phrase('Lifetime'); ?>
	                      	<?php else: ?>
	                      		<i class="far fa-flag"></i>  <?php echo $course_3_details['expiry_period'].' '.get_phrase('Days'); ?>
                      		<?php endif; ?>
                      	<?php endif; ?>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                      	<?php if(isset($course_1_details['title'])): ?>
                      		<img src="<?php echo site_url('assets/frontend/default-new/image/Group 17906.png') ?>" alt="">
