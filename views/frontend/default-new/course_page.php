                    ...
                    <div class="course-card">
                        ...
                        <div class="enrol">
                            ...
                            <h5>
                                ...
                                <?php else: ?>
                                    <?php echo $course_details['expiry_period'].' '.get_phrase('Days Left'); ?>
                                <?php endif; ?>
                            </h5>
                        </div>
                        ...
                        <div class="button">
                            ...
                            <?php else: ?>
                                <?php if ($course_details['is_free_course'] == 1) : ?>
                                    <a id="payment-button" href="<?php echo site_url('home/get_enrolled_to_free_course/' . $course_details['id']); ?>"><?php echo get_phrase('Enroll Now'); ?></a>
                                <?php else : ?>
...
<script>
        ...
        function showCustomPopupMessage() {
            ...
            confirmButton.addEventListener('click', function () {
                ...
                window.location.href = "<?php echo site_url('home/get_enrolled_to_free_course/' . $course_details['id']); ?>";
            });
