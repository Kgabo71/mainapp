<style>
/* Base styles for the cart table image */
.cart-table-image {
    display: flex;
    align-items: center;
}
...
/* Styles for larger screens (e.g., desktops and tablets) */
...
<div class="row">
    ...
    <div class="col-lg-3 col-md-4">
        <div class="cart-total">
            ...
            <?php else: ?>
                <form action="<?php echo site_url('index.php/payment/checkout') ?>" method="post">                    <div id="gift_email_section" class="<?php if(isset($_GET['gift'])): else:echo 'd-hidden'; endif; ?>">
 ...
 <script>
        ...
        function showCustomPopupMessage() {
            ...
            confirmButton.addEventListener('click', function () {
                ...
                window.location.href = "<?php echo site_url('index.php/payment/checkout') ?>";
            });
